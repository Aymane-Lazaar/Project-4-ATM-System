...
void GoBackToMainMenue()
{
    ...
    /*
    Command,Result,What the User Sees
    "system("pause");",The program halts and displays a system notification text.,Press any key to continue . . .
    "system("pause>0");",The program halts silently without displaying any text.,(Blank screen until a key is pressed)
    */
    ...
    if (Answer == 'y' || Answer == 'Y')
    {
        for (sClient &cl : vClients)
        {
            if (cl.AccountNumber == AccountNumber)
            {
                ...
                SaveCleintsDataToFile(ClientsFileName, vClients);
                cout
                    << "Done seccessfuely new balance is "
                    << cl.AccountBalance;
...
void DepositToClient(vector<sClient> vClients)
{
    sClient Client;
    ...
    //          << "] does not exists, Enter another Account Number? ";
...
void WithdrawClient(vector<sClient> vClients)
{
    sClient Client;
...
void ShowTotalBalancesScreen()
{
    ...
    cout << setw(15) << TotalBalnces;
}

void PerfromTransactionMenueOption(enTransactionMenueOptions TransactionMenueScreen)
{
    switch (TransactionMenueScreen)
    {
...
void TransactionMenuScreen()
{
    ...
    cout << "\t[4] Main Menue.\n";
    cout << "===========================================\n";
    PerfromTransactionMenueOption((enTransactionMenueOptions)ReadTransactionsMenueOption());
}
